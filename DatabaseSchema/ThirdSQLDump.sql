...
CREATE TABLE `crewcruiseship` (
  `crewMemberShipId` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cruiseshiprating` (
  `cruiseShipRatingId` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cruisetravelplan` (
  `cruiseTravelPlanId` int NOT NULL AUTO_INCREMENT,
  `shipId` int DEFAULT NULL,
...
CREATE TABLE `roomplan` (
  `roomPlanId` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `travelplanrating` (
  `travelPlanRatingId` int NOT NULL AUTO_INCREMENT,
  `customerId` int DEFAULT NULL,
  `travelPlanId` int DEFAULT NULL,
...
CREATE TABLE `travelplanstop` (
  `travelPlanStopId` int NOT NULL AUTO_INCREMENT,
  `stopDuration` int DEFAULT NULL,
...
-- Dump completed on 2020-11-25  9:32:49
